...
class Input extends TouchPad{
    static Up(){return this.Touching(0) || this.IsDown('w','W') || this.IsDown('ArrowUp') || this.Joy(0,0,1)}
    static Down(){return this.Touching(1) || this.IsDown('s','S') || this.IsDown('ArrowDown') || this.Joy(0,1,1)}
    static Left(){return this.Touching(2) || this.IsDown('a','A') || this.IsDown('ArrowLeft') || this.Joy(0,2,1)}
    static Right(){return this.Touching(3) || this.IsDown('d','D') || this.IsDown('ArrowRight') || this.Joy(0,3,1)}
    static Fire1(){return this.Touching(4) || this.IsSingle('k','K') || this.Btn(0,0,1)}
    static Fire2(){return this.Touching(5) || this.IsSingle('l','L') || this.Btn(1,0,1)}
    static Space(){return this.Any() || this.IsSingle(' ') || this.Btn(1,0) || this.Btn(0,0)}
}
